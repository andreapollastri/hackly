...
<head>
    <meta charset="utf-8">
    <title>Hackly Repo Scan Report</title>
    <style>
...
<body>
    ...
    <div class="header">
        ...
        <div class="subtitle">Authorized repository security scan report</div>
    </div>

    <table class="meta">
        <tr>
            <td class="label">Repository</td>
            <td>{{ $scan->repository?->full_name ?? '—' }}</td>
        ...
        <tr>
            ...
            <td colspan="3">{{ $scan->requester?->email ?? '—' }}</td>
        </tr>
    </table>
